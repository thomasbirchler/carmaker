...
% slip_max = slips.RL_Tractive_Slip.Data(1150+index)
% 
% 
...
% %plot(slips.RL_Tractive_Slip.Data(time), mu_rl, 'LineWidth', 3)
% hold on
...
% 
% [mu_rl_max, index] = max(mu_rl);
% slip_max = slips.RL_Braking_Slip.Data(7999+index);
% 
% figure
% %plot(slips.RL_Braking_Slip.Data(time), mu_rl)
% hold on
% %plot(slip_max, mu_rl_max, 'ro', 'LineWidth', 3)
% 
...
% 
% figure
% %plot(slips.RL_Braking_Slip.Data(time), mu_fl)
% hold on
...
% 
% figure
% %plot(traction_slip_true.Time, traction_slip_true.Data, 'DisplayName', 'Slip True')
% hold on
% %plot(traction_slip_best.Time, traction_slip_best.Data, 'DisplayName', 'Slip best')
% %plot(FxRL.time, FxRL.Data./FzRL.Data, 'DisplayName', 'mu')
% 
% legend('show')
% hold off